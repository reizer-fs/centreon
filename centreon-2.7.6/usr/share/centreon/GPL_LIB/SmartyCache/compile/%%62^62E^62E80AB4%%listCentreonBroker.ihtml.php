<?php /* Smarty version 2.6.18, created on 2016-09-02 19:54:37
         compiled from listCentreonBroker.ihtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 't', 'listCentreonBroker.ihtml', 6, false),)), $this); ?>
...
<form name='form' method='POST'>
    ...
    <tbody>
      ...
      <tr>
        <td><h4><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Centreon Broker<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></h4></td>
      </tr>
      <tr>
        <td><input type="text" name="searchCB" value="<?php echo $this->_tpl_vars['searchCB']; ?>
"></td>
...
" class="btc bt_success"><?php echo $this->_tpl_vars['msg']['addT']; ?>
				...
				&nbsp;&nbsp;&nbsp;
				<a href="?p=6090901" class="btc bt_info"><?php echo $this->_tpl_vars['msg']['addWizard']; ?>
</a>
			</td>
			<?php else: ?>
			<td>&nbsp;</td>
...
" type="hidden">
	...
	<table class="ListTable">
		<tr class="ListHeader">
			...
			<td class="ListColHeaderCenter"><?php echo $this->_tpl_vars['headerMenu_inputs']; ?>
</td>
			<td class="ListColHeaderCenter"><?php echo $this->_tpl_vars['headerMenu_outputs']; ?>
</td>
			<td class="ListColHeaderCenter"><?php echo $this->_tpl_vars['headerMenu_loggers']; ?>
</td>
...
"><?php echo $this->_tpl_vars['elemArr'][$this->_sections['elem']['index']]['RowMenu_desc']; ?>
			...
			<td class="ListColCenter"><?php echo $this->_tpl_vars['elemArr'][$this->_sections['elem']['index']]['RowMenu_inputs']; ?>
</td>
			<td class="ListColCenter"><?php echo $this->_tpl_vars['elemArr'][$this->_sections['elem']['index']]['RowMenu_outputs']; ?>
</td>
			<td class="ListColCenter"><?php echo $this->_tpl_vars['elemArr'][$this->_sections['elem']['index']]['RowMenu_loggers']; ?>
</td>
