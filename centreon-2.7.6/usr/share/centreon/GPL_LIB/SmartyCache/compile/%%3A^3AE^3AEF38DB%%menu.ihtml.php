...
?>
	            <li>
	                <?php if ($this->_tpl_vars['elemArr2'][$this->_sections['elem2']['index']]['Menu2UrlPopup']): ?>
	                    <a href='<?php echo $this->_tpl_vars['elemArr2'][$this->_sections['elem2']['index']]['Menu2UrlPopupOpen']; ?>
' target="_blank" style="white-space:nowrap;"><?php echo $this->_tpl_vars['elemArr2'][$this->_sections['elem2']['index']]['Menu2Name']; ?>
</a>
	                <?php else: ?>
	                    <a href='<?php echo $this->_tpl_vars['elemArr2'][$this->_sections['elem2']['index']]['Menu2Url']; ?>
